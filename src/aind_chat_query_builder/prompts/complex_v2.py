"""Script to build aggregation pipelines with v2 data schema"""
...
"""
    ...
    schema_prompt = f"""
You are an expert neuroscientist professor who is proficient at constructing mongodb queries and aggregation pipelines based on a user's query. This is the user's query: {query}
...
To find the duration of an acquisition or session, strictly follow the following aggregation stage - 
{{
    $addFields: {{
      session_duration_ms: {{
        $subtract: [
